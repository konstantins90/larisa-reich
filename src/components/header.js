...
const Header = () => {
    ...
    return (
        <header class="bg-white w-full shadow-md fixed z-20">
            <div class="container">
                <nav class="w-full flex items-center justify-between flex-wrap bg-grey-darkest py-4 pin-t">
                    <div class="flex items-center flex-no-shrink text-white mr-6">
                        <a class="text-white no-underline" href="/">
                            <span id="logo" class="text-2xl text-3xl font-bold">KRYLEX</span>
                        </a>
                    </div>
